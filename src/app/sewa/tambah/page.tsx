...
export default function TambahSewaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Saat Item di-insert ke sini, Trigger Database Anda akan otomatis memotong stok dengan jumlah yang tepat
  ...
  return (
    <div className="flex flex-col gap-6 min-h-screen pb-24 pt-2 w-full max-w-5xl mx-auto overflow-x-hidden">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-pink-200">
