          ...
          <div className="w-full md:w-2/3 space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={namaBarang} onChange={(e) => setNamaBarang(e.target.value)} className="w-full pl-11 pr-4 py-3 text-sm rounded-xl bg-pink-50 border border-transparent focus:border-pink-500 text-slate-800 outline-none" required />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" value={stok} onChange={(e) => setStok(e.target.value)} min="0" className="w-full pl-11 pr-4 py-3 text-sm rounded-xl bg-pink-50 border border-transparent focus:border-pink-500 text-slate-800 outline-none" required />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="number" value={harga} onChange={(e) => setHarga(e.target.value)} min="0" className="w-full pl-11 pr-4 py-3 text-sm rounded-xl bg-pink-50 border border-transparent focus:border-pink-500 text-slate-800 outline-none" required />
              </div>
            </div>
            ...
            <div className="pt-6 mt-6 pb-2 border-t border-pink-100 flex justify-end">
              <button type="submit" disabled={isSubmitting} className="flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 px-8 rounded-xl text-sm transition-transform hover:scale-[1.02] shadow-sm w-full sm:w-auto justify-center disabled:opacity-50">
                <Save size={18} />
